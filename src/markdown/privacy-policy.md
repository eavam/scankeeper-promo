---
title: "ScanKeeper App Privacy Policy & Terms"
date: "2026-07-14"
path: "/privacy-policy"
---

<article id="privacy-policy">
  <h1>ScanKeeper App Privacy Policy</h1>
...
- **Free version shows ads.** Ads are served by Google AdMob and configured mediation partners. In regions that require consent, we ask you through Google's consent form before personalised ads run.
...
- **Pseudonymous diagnostics.** We use TelemetryDeck for privacy-focused usage signals and Sentry for crash reporting (with input fields masked in session replays). We do not attach your name or email address.
...
If you use the free version of ScanKeeper, Google AdMob and the configured mediation networks may access your device's advertising identifier (**IDFA** on iOS, **GAID** on Android) to deliver and measure ads. The current mediation networks are Unity Ads, Liftoff Monetize, Pangle, and, on Android, Yandex Ads.
...
- **Show ads in the free version.** Serve banner and interstitial ads through Google AdMob and configured mediation partners, and measure their performance, in line with your consent and ATT choices.
...
| --- | --- | --- | --- |
| **Google AdMob and configured mediation networks** | Independent controllers | Serves and measures banner/interstitial ads in the free version. Receives IDFA/GAID where consent allows. Current mediation networks: Unity Ads, Liftoff Monetize, Pangle, and Yandex Ads on Android. | https://policies.google.com/technologies/ads |
...
The current mediation partners publish their own notices: Unity Ads at https://unity.com/legal/game-player-and-app-user-privacy-policy, Liftoff Monetize at https://liftoff.ai/privacy-policy/, Pangle at https://www.pangleglobal.com/privacy, and Yandex at https://yandex.com/legal/confidential/en/.
...
<article id="terms-of-service">
  <h1>ScanKeeper App Terms of Service</h1>
